...
import Proyecto_Final.Controlador.Venta;
import Proyecto_Final.Modelo.Inventario;
...
public class ejecucion {
    ...
    private static int mostrarListaProductos(Proyecto_Final.Modelo.Producto[] productos) {
        StringBuilder listaProductos = new StringBuilder("Seleccione un producto:\n");

        for (int i = 0; i < productos.length; i++) {
            Proyecto_Final.Modelo.Producto producto = productos[i];
